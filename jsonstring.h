...
/*
*	req_type : ack , data
*	message : client_connected , slave_server_connected , parse_error, key_error, commit_failed
*	put_success, delete_success, update_success, 
*	registration_successful, migration_new_server, ready_for_migration, no_slave_server_active,
...
/*
*	inform the leader slave server to proceed with migration
